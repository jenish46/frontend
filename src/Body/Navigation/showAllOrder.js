            ...
            <div>
                ...
                <div className="row" style={{ backgroundColor: "black", border: "solid grey" }}>
                    <div className="col-lg-4">
                        ...
                        <h1 className="text-left text-light" > <i className="fa fa-shopping-cart"></i>:{this.state.data.length}</h1>
                    </div>
            <div className="col-lg-4">
                <img src={"http://localhost:3000/images/logo.png"} height="50"/>
            </div>
                    <div className="col-lg-4">
                    <h1 className="text-right text-light"><i class="fa fa-money" aria-hidden="true"></i>: {this.state.total}</h1>
</div>
                                                                    ...
                                                                    return (
                                                                        <>
                                                                            <div className="row mb-2 mb-sm-0 py-25">
                                                                                ...
                                                                                <div className="col-2 text-secondary-d2">{parseInt(food.food.Price) * parseInt(food.qty)}</div>
                                                                            </div>
