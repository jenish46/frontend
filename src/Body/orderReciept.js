    					...
    					<table className="table table-condensed">
    						...
    						<tbody>
...

								{
									...
									data.ProductId.map((food)=>{
return(

<tr>
    								<td>{food.food.Name}</td>
    								<td className="text-center">${food.food.Price}</td>
    								<td className="text-center">{food.qty}</td>
    								<td className="text-right">{parseInt(food.food.Price)*food.qty}</td>
    							</tr>
...
<td className="thick-line text-left"><button className="btn btn-danger" onClick={this.cancel} >Cancel Order</button></td>
    								

</>):(<>

	<td className="thick-line text-left"><button className="btn btn-primary"  >Order Accepted</button></td>
